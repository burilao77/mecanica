...
class ServicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'total_cost' => ['type' => 'decimal', 'length' => 5, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'star_date' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'services_ibfk_1' => ['type' => 'foreign', 'columns' => ['vehicle_id'], 'references' => ['vehicles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'services_ibfk_2' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'total_cost' => 1.5,
            'star_date' => '2017-07-03 03:05:03',
            'end_date' => '2017-07-03 03:05:03',
            'state' => 1,
            'created' => '2017-07-03 03:05:03',
            'modified' => '2017-07-03 03:05:03',
            'vehicle_id' => 1,
            'category_id' => 1
        ],
    ];
